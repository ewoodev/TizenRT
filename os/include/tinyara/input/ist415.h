...
struct ist415_ops_s {
	CODE void (*irq_enable)(struct ist415_dev_s *dev);	/* Enables the irq */
	CODE void (*irq_disable)(struct ist415_dev_s *dev);	/* Disables the irq */
	CODE void (*power_off)(struct ist415_dev_s *dev);	/* low the reset */
	CODE void (*power_on)(struct ist415_dev_s *dev);	/* High the reset */
};
